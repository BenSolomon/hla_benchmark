...
plt_fig_main <- plot_grid(
  plot_grid(
    testing_plt, drb345_similarity_plt,
    ncol = 1,
    align = "v",
    axis = "lr",
    labels = c("A","C")
  ...
  plot_grid(
    allele_contingency_plt, drb345_accuracy_plt,
    ncol = 1,
    align = "v",
    axis = "lr",
    labels = c("B","D")
...
```
```{r}
save_plot("figures_pdf/v2/s3_deb.pdf", plt_fig_supp, base_height = 9, base_width = 8)
```
