...
# Import read statistics
subsample_reads_arcas_log_dir <- sprintf("%s/arcasHLA", subsample_reads_path)
subsample_reads_alignment_stats_df <- hla_mapping_stats_import_v2(subsample_reads_samples, subsample_reads_arcas_log_dir)
subsample_reads_alignment_stats_df <- subsample_reads_alignment_stats_df %>% 
  mutate(reads = total_reads)
subsample_reads_alignment_stats_df
```
