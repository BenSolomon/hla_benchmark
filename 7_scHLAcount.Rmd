...
```{r}
save_plot("figures_pdf/v2/7_scHLA.pdf", plt_fig_main, base_height = 5, base_width = 14)
```
...
```
```{r}
save_plot("figures_pdf/v2/s6_scHLA.pdf", plt_fig_supp, base_height = 5, base_width = 6)
```
