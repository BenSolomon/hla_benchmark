...
# saveRDS(all_hla_drb345_3p_filtered, "data/all_hla_drb345_filtered_pmid_scRNA.RDS")
# saveRDS(all_hla_drb345_bulk_filtered, "data/all_hla_drb345_filtered_pmid_bulkRNA.RDS")

# all_hla_drb345_3p_filtered <- readRDS("data/all_hla_drb345_filtered_pmid_scRNA.RDS")
# all_hla_drb345_bulk_filtered <- readRDS("data/all_hla_drb345_filtered_pmid_bulkRNA.RDS")
```
...
```
```{r}
save_plot("figures_pdf/v2/s1_platforms.pdf", plt_fig_supp, base_height = 3, base_width = 8)
```
...
saveRDS(
  ...
  "figures_object/6_platforms.RDS"
)
